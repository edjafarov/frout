  ...
  function PPRouter() {
    ...
    stateConfig[uniquePath] = {
      model: function model(params, transition) {
        ...
        console.log(uniquePath, "1passed");
        return RoutePipe(null, handlerContext).then(function (data) {
          console.log(uniquePath, "passed");
  ...
  PPRouter.use = function (adapter) {
    ...
    if (adapter.handleTransition) {
      ...
      router.transitionTo = function (to, context) {
        console.log("START TRANSITION", to);
        var handler = transitionTo.call(router, to);

        if (context) handler._context = context;

        return new Promise(function (resolve, reject) {
          console.log("HANDLING0");
          handler.then(function () {
...
},{"../../src/PromisePipe":165,"./router.js":161,"es6-promise":3}],3:[function(require,module,exports){
...
var RootComp = (function (_React$Component) {
  _inherits(RootComp, _React$Component);

  function RootComp() {
    _classCallCheck(this, RootComp);

    _get(Object.getPrototypeOf(RootComp.prototype), "constructor", this).apply(this, arguments);
  }
...
var ItemsComp = (function (_React$Component2) {
  _inherits(ItemsComp, _React$Component2);

  function ItemsComp() {
    _classCallCheck(this, ItemsComp);

    _get(Object.getPrototypeOf(ItemsComp.prototype), "constructor", this).apply(this, arguments);
  }

  _createClass(ItemsComp, [{
    key: "render",
    value: function render() {
...
var ItemComp = (function (_React$Component3) {
  _inherits(ItemComp, _React$Component3);

  function ItemComp() {
    _classCallCheck(this, ItemComp);

    _get(Object.getPrototypeOf(ItemComp.prototype), "constructor", this).apply(this, arguments);
  }

  _createClass(ItemComp, [{
    key: "render",
    value: function render() {
      return _react2["default"].createElement(
        "div",
...
Router(function (Router) {
  Router("/items", function (Router) {
    Router('/:id').component(_react2["default"].createElement.bind(_react2["default"], ItemComp)).then(getItem);
  }).component(_react2["default"].createElement.bind(_react2["default"], ItemsComp)).then(getItems);
}).component(_react2["default"].createElement.bind(_react2["default"], RootComp)).then(count);
...
},{"../../index":2,"react":159}],161:[function(require,module,exports){
(function (process){
...
},{"_process":4}],162:[function(require,module,exports){
(function (process,global){
/*!
 * @overview es6-promise - a tiny implementation of Promises/A+.
 * @copyright Copyright (c) 2014 Yehuda Katz, Tom Dale, Stefan Penner and contributors (Conversion to ES6 API by Jake Archibald)
...
},{"./RemoteAPIHandlers":166,"./TransactionController":167,"es6-promise":162,"json-stringify-safe":163,"stacktrace-js":164}],166:[function(require,module,exports){
"use strict";
...
},{"./TransactionController":167}],167:[function(require,module,exports){
'use strict';
...
},{"es6-promise":162}],"app":[function(require,module,exports){
"use strict";
...
function mount(data) {
  _react2["default"].render(data, document.getElementById('content'));
}
...
document.getElementById('content').onclick = function (e) {
  e.preventDefault();
  e.stopPropagation();
  if (e.target.nodeType == 1 && e.target.href && e.target.href.indexOf(document.location.origin) == 0 && document.location.pathname !== e.target.pathname) {
    //is a link
...
},{"../../adapters/HistoryApiAdapter":1,"./router":160,"react":159}]},{},[]);
