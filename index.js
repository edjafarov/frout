  ...
  function PPRouter(){
    ...
    stateConfig[uniquePath] = {
      model: function(params, transition){
        ...
        if(!stateConfig[uniquePath].action){
          return null;
        } else {

          return Promise.resolve(stateConfig[uniquePath].action(null, handlerContext)).then(function(data){
    ...
    RoutePipe.do = function(action){
      stateConfig[uniquePath].action = action;
      return RoutePipe;
    }
