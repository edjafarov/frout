...
describe('Router', function(){
  ...
  PPRouter(function(PPRouter){
    PPRouter('posts', function(PPRouter){
      PPRouter(':id').do(postsId)
      PPRouter('new').do(postsNew)
    }).do(rootPosts)
    PPRouter('items', function(PPRouter){
      PPRouter(':id').do(itemsId)
      PPRouter('new').do(itemsNew)
    }).do(rootItems)
  }).do(root)
...
describe('Router', function(){
  ...
  PPRouter(function(PPRouter){
    PPRouter('posts', function(PPRouter){
      PPRouter(':id').do(delayFor(40, postsId))
    }).do(delayFor(50,rootPosts))
  })
  before(function(done){
